...
var _user$project$Point$string = function (_p0) {
	var _p1 = _p0;
	return A2(
...
var _user$project$Point$translate = F3(
	function (dx, dy, _p2) {
		var _p3 = _p2;
		return {x: _p3.x + dx, y: _p3.y + dy};
	});
var _user$project$Point$init = F2(
	function (x, y) {
		return {x: x, y: y};
	});
...
var _user$project$Magnet$encode = F2(
	function (_p0, word) {
		var _p1 = _p0;
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'x',
					_1: _elm_lang$core$Json_Encode$int(_p1.x)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'y',
						_1: _elm_lang$core$Json_Encode$int(_p1.y)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'word',
							_1: _elm_lang$core$Json_Encode$string(word)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Magnet$Magnet = F3(
	function (a, b, c) {
		return {id: a, text: b, location: c};
	});
var _user$project$Magnet$decode = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Magnet$Magnet,
...
var _user$project$Size$init = F2(
	function (width, height) {
		return {width: width, height: height};
	});
var _user$project$Size$Size = F2(
	function (a, b) {
		return {width: a, height: b};
	});

var _user$project$State$addMagnet = F2(
	function (magnet, state) {
		var newMagnets = {ctor: '::', _0: magnet, _1: state.magnets};
		return _elm_lang$core$Native_Utils.update(
			state,
			{magnets: newMagnets});
	});
var _user$project$State$setDimensions = F2(
	function (dimensions, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{dimensions: dimensions});
	});
var _user$project$State$State = F5(
	function (a, b, c, d, e) {
		return {dimensions: a, cursor: b, cursorVisible: c, magnets: d, mode: e};
	});
var _user$project$State$Insert = function (a) {
	return {ctor: 'Insert', _0: a};
};
var _user$project$State$handleNormalKeyPress = F2(
	function (code, state) {
		var maxY = state.dimensions.height;
		var maxX = state.dimensions.width;
		var y = state.cursor.y;
		var x = state.cursor.x;
		var _p0 = _elm_lang$core$Char$fromCode(code);
		switch (_p0.valueOf()) {
			case 'j':
				return (_elm_lang$core$Native_Utils.cmp(y, maxY - 1) < 0) ? _elm_lang$core$Native_Utils.update(
					state,
					{
						cursor: A2(_user$project$Point$init, x, y + 1)
					}) : state;
			case 'k':
				return (_elm_lang$core$Native_Utils.cmp(y, 0) > 0) ? _elm_lang$core$Native_Utils.update(
					state,
					{
						cursor: A2(_user$project$Point$init, x, y - 1)
					}) : state;
			case 'h':
				return (_elm_lang$core$Native_Utils.cmp(x, 0) > 0) ? _elm_lang$core$Native_Utils.update(
					state,
					{
						cursor: A2(_user$project$Point$init, x - 1, y)
					}) : state;
			case 'l':
				return (_elm_lang$core$Native_Utils.cmp(x, maxX - 1) < 0) ? _elm_lang$core$Native_Utils.update(
					state,
					{
						cursor: A2(_user$project$Point$init, x + 1, y)
					}) : state;
			case 'i':
				return _elm_lang$core$Native_Utils.update(
					state,
					{
						mode: _user$project$State$Insert('')
					});
			default:
				return A2(
		...
		switch (_p1) {
			...
			case 8:
				return _elm_lang$core$Native_Utils.update(
					...
					{
						mode: _user$project$State$Insert(
							A2(_elm_lang$core$String$dropRight, 1, text))
					});
			default:
				var $char = _elm_lang$core$Char$fromCode(code);
				return _elm_lang$core$Native_Utils.update(
					state,
					{
						mode: _user$project$State$Insert(
...
var _user$project$State$handleKeyPress = F2(
	function (code, state) {
		var _p2 = state.mode;
		if (_p2.ctor === 'Normal') {
			return A2(_user$project$State$handleNormalKeyPress, code, state);
		} else {
			return A3(_user$project$State$handleInsertKeyPress, code, _p2._0, state);
		}
	});

var _user$project$Grid$key = function (point) {
	return _user$project$Point$string(point);
};
var _user$project$Grid$put = F3(
	function (point, value, _p0) {
		var _p1 = _p0;
		return {
			dict: A3(
				_elm_lang$core$Dict$insert,
				_user$project$Grid$key(point),
				value,
				_p1.dict),
			maxX: A2(_elm_lang$core$Basics$max, point.x, _p1.maxX),
			maxY: A2(_elm_lang$core$Basics$max, point.y, _p1.maxY)
		};
	});
...
var _user$project$Grid$empty = {dict: _elm_lang$core$Dict$empty, maxX: 0, maxY: 0};
var _user$project$Grid$Grid = F3(
	function (a, b, c) {
		return {dict: a, maxX: b, maxY: c};
	});
							...
							function (x) {
								return A2(
									...
									A2(
										...
										A2(_user$project$Point$init, x, y),
										buffer));
							},
							A2(_elm_lang$core$List$range, 0, maxX))));
			},
					...
					return A3(
						...
						F2(
							function (_p2, b) {
								var _p3 = _p2;
								return A3(
									_user$project$Grid$put,
									A3(_user$project$Point$translate, _p3._0 + 1, 1, _p1.location),
									_elm_lang$core$String$fromChar(_p3._1),
									b);
							}),
						buf,
						A2(
							...
							_elm_lang$core$String$toList(_p1.text)));
				}),
			buffer,
			magnets);
	});
var _user$project$View$addFrame = F3(
	function (width, height, buffer) {
		var buf1 = A3(
			...
			F2(
				function (x, b) {
					return A3(
						_user$project$Grid$put,
						A2(_user$project$Point$init, x, 0),
						'-',
						b);
				}),
			buffer,
		...
		var buf2 = A3(
			...
			F2(
				function (x, b) {
					return A3(
						_user$project$Grid$put,
						A2(_user$project$Point$init, x, height + 1),
						'-',
						b);
				}),
			buf1,
		...
		var buf3 = A3(
			...
			F2(
				function (y, b) {
					return A3(
						_user$project$Grid$put,
						A2(_user$project$Point$init, 0, y),
						'|',
						b);
				}),
			buf2,
		...
		var buf4 = A3(
			...
			F2(
				function (y, b) {
					return A3(
						_user$project$Grid$put,
						A2(_user$project$Point$init, width + 1, y),
						'|',
						b);
				}),
			buf3,
		...
		return A3(
			_user$project$Grid$put,
			A2(_user$project$Point$init, width + 1, height + 1),
			'+',
			A3(
				_user$project$Grid$put,
				A2(_user$project$Point$init, width + 1, 0),
				'+',
				A3(
					_user$project$Grid$put,
					A2(_user$project$Point$init, 0, height + 1),
					'+',
					A3(
						_user$project$Grid$put,
						A2(_user$project$Point$init, 0, 0),
						'+',
						buf4))));
	});
...
var _user$project$View$addCursor = F4(
	function (_p4, visible, mode, buffer) {
		...
		var _p10 = _p5.y;
		var _p9 = _p5.x;
		var _p6 = {ctor: '_Tuple2', _0: mode, _1: visible};
		_v3_2:
		do {
			if (_p6.ctor === '_Tuple2') {
				if (_p6._0.ctor === 'Normal') {
					if (_p6._1 === true) {
						var point = A2(_user$project$Point$init, _p9 + 1, _p10 + 1);
						return A3(_user$project$Grid$put, point, _user$project$View$cursorString, buffer);
					} else {
						break _v3_2;
					}
				} else {
					...
					return A3(
						...
						F2(
							function (_p7, b) {
								...
								return A3(
									_user$project$Grid$put,
									A2(_user$project$Point$init, (_p9 + _p8._0) + 1, _p10 + 1),
									_elm_lang$core$String$fromChar(_p8._1),
									b);
							}),
						buffer,
						A2(
							...
							_elm_lang$core$String$toList(fullText)));
				}
			} else {
				break _v3_2;
			}
...
var _user$project$View$render = function (state) {
	var maxY = state.dimensions.height;
	var maxX = state.dimensions.width;
	return _user$project$View$bufferToLines(
		A4(
			_user$project$View$addCursor,
			state.cursor,
			state.cursorVisible,
			state.mode,
			A3(
				_user$project$View$addFrame,
				maxX,
				maxY,
				A2(_user$project$View$addMagnets, state.magnets, _user$project$Grid$empty))));
};

var _user$project$Fridge$content = function (model) {
	return _user$project$View$render(model.state);
};
var _user$project$Fridge$channelName = function (status) {
	var _p0 = status;
	switch (_p0.ctor) {
		case 'NotConnected':
			return _p0._0;
...
var _user$project$Fridge$Flags = function (a) {
	return {url: a};
};
var _user$project$Fridge$Model = F3(
	function (a, b, c) {
		return {socket: a, state: b, status: c};
	});
var _user$project$Fridge$Connected = function (a) {
	return {ctor: 'Connected', _0: a};
};
var _user$project$Fridge$Connecting = function (a) {
	return {ctor: 'Connecting', _0: a};
};
var _user$project$Fridge$NotConnected = function (a) {
	return {ctor: 'NotConnected', _0: a};
};
var _user$project$Fridge$init = function (flags) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
...
var _user$project$Fridge$ChannelLeft = {ctor: 'ChannelLeft'};
var _user$project$Fridge$ChannelJoined = {ctor: 'ChannelJoined'};
var _user$project$Fridge$ChannelTextChanged = function (a) {
	return {ctor: 'ChannelTextChanged', _0: a};
};
var _user$project$Fridge$JoinChannel = {ctor: 'JoinChannel'};
var _user$project$Fridge$view = function (model) {
				...
				{ctor: '[]'},
				{
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_community$html_extra$Html_Events_Extra$onEnter(_user$project$Fridge$JoinChannel),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Fridge$ChannelTextChanged),
											_1: {ctor: '[]'}
										}
									}
								}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Fridge$JoinChannel),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Connecting to', _p1._0)),
					_1: {ctor: '[]'}
				});
		default:
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Fridge$content(model),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				});
...
var _user$project$Fridge$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$Fridge$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'NoOp':
				return A2(
					...
					{ctor: '[]'});
			case 'PressedKey':
				var newState = A2(_user$project$State$handleKeyPress, _p2._0, model.state);
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{state: newState});
				var _p3 = {ctor: '_Tuple3', _0: model.status, _1: model.state.mode, _2: newState.mode};
				if ((((_p3.ctor === '_Tuple3') && (_p3._0.ctor === 'Connected')) && (_p3._1.ctor === 'Insert')) && (_p3._2.ctor === 'Normal')) {
					var room_id = A2(_elm_lang$core$Basics_ops['++'], 'fridge:', _p3._0._0);
					var payload = A2(_user$project$Magnet$encode, model.state.cursor, _p3._1._0);
					var push = A2(
						_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
						payload,
						A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'add_word', room_id));
					var _p4 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push, model.socket);
					var socket = _p4._0;
					var cmd = _p4._1;
			...
			case 'PhoenixMsg':
				var _p5 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p2._0, model.socket);
				var socket = _p5._0;
				var phxCmd = _p5._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{socket: socket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Fridge$PhoenixMsg, phxCmd)
				};
			case 'JoinChannel':
				...
				if (_p6.ctor === 'NotConnected') {
					...
					var channel = A2(
						...
						A2(
							...
							_elm_lang$core$Basics$always(_user$project$Fridge$ChannelJoined),
							_fbonetti$elm_phoenix_socket$Phoenix_Channel$init(room)));
					var _p7 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, socket);
			...
			case 'ChannelTextChanged':
				var _p8 = model.status;
				if (_p8.ctor === 'NotConnected') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								status: _user$project$Fridge$NotConnected(_p2._0)
							}),
						{ctor: '[]'});
				} else {
					return A2(
			...
			case 'ChannelLeft':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							status: _user$project$Fridge$NotConnected(name)
						}),
					{ctor: '[]'});
			case 'ReceiveMagnet':
...
var _user$project$Fridge$PressedKey = function (a) {
...
var _user$project$Fridge$subscriptions = function (model) {
	...
	if (_p10.ctor === 'Connected') {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.socket, _user$project$Fridge$PhoenixMsg),
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$presses(_user$project$Fridge$PressedKey),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Time$every, 500 * _elm_lang$core$Time$millisecond, _user$project$Fridge$BlinkCursor),
						_1: {ctor: '[]'}
					}
				}
			});
	} else {
		return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.socket, _user$project$Fridge$PhoenixMsg);
	}
};
var _user$project$Fridge$NoOp = {ctor: 'NoOp'};

var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Fridge$init, view: _user$project$Fridge$view, update: _user$project$Fridge$update, subscriptions: _user$project$Fridge$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (url) {
